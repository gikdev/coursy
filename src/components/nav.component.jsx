    ...
    <>
      <nav className="navbar bg-base-100">
        <div className="flex-1">
          <Link to="/coursy/" className="btn btn-ghost text-xl">
            <span>Coursy</span>
          </Link>
        </div>
